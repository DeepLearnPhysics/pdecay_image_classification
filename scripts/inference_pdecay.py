...
TUTORIAL_DIR     = '../config/'
TEST_IO_CONFIG   = os.path.join(TUTORIAL_DIR, 'pdecay_test.cfg' )
TEST_BATCH_SIZE  = 100
SNAPSHOT = "../weights/weight-24999"
GPU=0
...
csv_filename='2plane_inference.csv'
...
while ctr < num_events:
    ...
    feed_dict = { data_tensors  : [test_data0, test_data1]}
    ...
    for j in xrange(len(softmax_batch)):
        ...
        event_particle = ana_chain.particle_mcst_branch #used to be mctruth
